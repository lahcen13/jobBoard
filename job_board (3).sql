...
INSERT INTO `applied` (`id`, `motivation_people`, `advertisement_id`, `people_id`, `first_name`, `last_name`) VALUES
(5, 'Gdslmksmlfmsdfmlsdmfkmskfls', 4, 23, 'xdcvsdqssqd', 'dsvdsvdsvdsvd'),
(2, 'aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa', 4, 23, 'xdcvsdqssqd', 'dsvdsvdsvdsvd'),
(3, 'aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa', 4, 23, 'xdcvsdqssqd', 'dsvdsvdsvdsvd'),
(4, 'sdoipek,mfekùjmgfeijzeilezijo', 4, 23, 'dsjfkksdkfùfze', 'fslmfksdfkmlfd'),
(6, 'sdf,msdfmlsdlmsdklmfsklsefnlef,xkjdn;nkjhyjkjshkjeszhjghrbgfgfg', 4, 24, 'dsjfkksdkfùfze', 'fslmfksdfkmlfd'),
(7, '1111111111111111111111111111111', 1, 24, 'SALUT', 'AHAHAHAAH');
...
INSERT INTO `companies` (`id`, `name`, `activities`, `address`, `postal_code`, `city`, `siret`, `password_`, `number_employes`, `website`, `phone`, `email`, `contact_name`, `image`, `contact`) VALUES
(1, 'epitech', 'school', 'bd paris ', 13003, 'Marseille', '12312312322', 'epitech', 12, 'https://epitech.eu', 766564783, 'epitech@epitech.eu', 'vicent', 'epitech.png', 'M. Jean Ive');
...
(24, 'bourlon', 'lyann', '$2b$10$QBryUhLMDpWqt.uzq2Zoku/EDk6y/BEpKxfVyM68.Sq5vFUgjqrQy', 'ssdfd@eed.eu', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'user'),
(20, 'admin', 'user', '$2b$10$opykjDBXi6CUwrYuzGTQku9UMo2rmvwG02fVgwR33ZA7WqadATGH6', 'lyann@gmail.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'admin'),
(23, 'bourlon', 'lyann', '$2b$10$u/Gasz9f.KWDnBf15uQ.YOliB9x5WHmZE/Fgn8ExMRcNN3MgNimD.', 'lyann.bourlon@epitech.eu', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'user'),
(22, 'bourlon', 'lyann', '$2b$10$7YQxpU3THRSKl2KA6Pyj1O4NikyIaJ0wTGsZx18WW.wBLHeYSaD2y', 'test@blabl.ru', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'user');
